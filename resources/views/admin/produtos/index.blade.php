        ...
        <div class="row px-5 my-4">
            <div class="col-12 bg-white px-4">
                <div class="row justify-content-between my-4 ">
                    ...
                    <div class="col-auto">
                        <a href="{{ route('produtos.create') }}" class="btn text-white fw-bold" style="background-color:#145f7c;">ADICIONAR</a>
                    </div>
                    <div class="col-auto">
                    ...
                    @foreach ($produtos as $produto)
                        <div class="col-4 mb-4">
                            <div class="card" style="width: 18rem;">
                                <img src="{{ url('storage/' . $produto->imagem_url) }}" class="card-img-top" height="250px" alt="...">
                                <div class="card-body">
                                    <h5 class="card-title">{{ $produto->nome }}</h5>
                                    <h5 class="card-text my-3 text-info">{{number_format($produto->preco,2,',','.') }}</h5>
