...
<body>
					...
					<div class="main-menu-wrap">
						...
						<nav class="main-menu">
							<ul>
								...
								<li><a href="#atividades">Actividades</a>
								</li>
	...
	<!-- hero area -->
	<div class="hero-area ">
		<img src="assets/img/escritolandia2.jpg" alt="">
		<div class="container">
			<div class="row">
				<div class="col-lg-9 offset-lg-2 text-center">
					<div class="hero-text">
						 <!--  <div class="hero-text-tablecell">
							<p class="subtitle">comercio Electronico</p>
							 <h1>Delicious Seasonal Fruits</h1> 
							 <div class="hero-btns">
								<a href="shop.html" class="boxed-btn"></a>
								<a href="contact.html" class="bordered-btn"></a> 
							</div> 
						</div>   -->
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-box subscribe">
						...
						<form>
							...
							<button type="submi"><i class="fas fa-paper-plane"></i></button>
						</form>
					</div>
				</div>
			</div>
